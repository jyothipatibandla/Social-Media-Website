...
<input class="form-control mb-2 mr-sm-2" type="text" name="searchitem" id="searchitem" required />
</div>
<button type="submit" name="service" value="search" class="btn btn-primary mb-2" onclick="myFunction()">Search</button>
</form>
<h5>Results:</h5>
...
<script>
function myFunction() {
var inpObj=document.getElementById("searchitem").value; 
	//var inpObj = document.getElementById("searchitem").value;
	if(inpObj == ""){
